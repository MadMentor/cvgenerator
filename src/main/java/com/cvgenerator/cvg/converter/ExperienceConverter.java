...
public class ExperienceConverter extends AbstractConverter<ExperienceDto, Experience> {
    ...
    public Experience toEntity(ExperienceDto experienceDto) {
        ...
        // if isCurrent is true then endDate is not necessary
        ...
        Optional<BasicInformation> optionalBasicInformation = basicInformationRepo.findById(experienceDto.getExperienceId());
